...
Функция ИзСтроки(Знач СтрокаИсточник, Знач Разделитель = ",") Экспорт
	...
	Пока Истина Цикл
		...
		Если следующийРазделитель < текПозиция Тогда
		...
		ИначеЕсли следующийРазделитель < координатыКавычек.Начало // разделитель до кавычек
			ИЛИ координатыКавычек.Отсутствуют Тогда               // поле начинается с кавычек, но мы их уже пропустили
		...
		ИначеЕсли следующийРазделитель > координатыКавычек.Начало Тогда
			
			// Разделитель внутри кавычек или после найденных, а могут быть еще,
			// сдвигаемся на конец кавычек и продолжаем поиск
